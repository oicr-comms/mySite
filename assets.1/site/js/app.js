jQuery(function($) {
    ...
    $('#side-nav-toggle').on('click', function() {
        ...
        $('#main-website-area').toggleClass('pushed');
    });
    ...
    $(window).resize(function() {
        if ($(window).width() >= 850) {
            ...
            $('#main-website-area').removeClass('pushed');
        }
    });
});
...
//         var alwaysSticky = window.STICKY_BY_DEFAULT_BELOW || 850;
...
//         var breakpoint = window.GRID_FLOAT_BREAKPOINT || 850;
